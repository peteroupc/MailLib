...
namespace PeterO {
  ...
  public static class DataUtilities {
    ...
    /// </param><param name='offset'>The Index starting at 0 where the string portion to write begins.
    ...
    /// plus
    /// <paramref name='length'/>
    /// is greater than the string's length.</exception><exception cref='System.IO.IOException'>An I/O error occurred.</exception><exception cref='System.ArgumentException'>Either
    /// <paramref name='offset'/>
    /// or
    /// <paramref name='length'/>
    ...
    /// <paramref name='str'/>
    /// is null.</exception><exception cref='System.ArgumentException'>Either "offset" or "length" is less than 0 or greater
