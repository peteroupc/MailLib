...
namespace PeterO.Mail {
  ...
  public static class DataUris {
    ...
    /// form of a byte array, where the Data URI is given as a URI object.</summary>
    /// <param name='uri'>The Data URI in the form of a URI object.
    /// </param>
