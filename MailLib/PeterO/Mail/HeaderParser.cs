...
35 &&
                  str[index] <= 58) || (str[index] >= 60 && str[index] <=
126))) {
              ++index;
            }
          } else {
...
str[index]
                <= 57) || (str[index] == 43)) && ((str[index + 1] >= 65 &&
str[index + 1] <=
                90) || (str[index + 1] >= 97 && str[index + 1] <= 122) ||
(str[index + 1] >=
...
str[index +
                  5] <= 122) || (str[index + 5] >= 47 && str[index + 5] <=
57) || (str[index +
                  5] == 43)) && ((str[index + 6] >= 65 && str[index + 6] <= 90) ||
              (str[index +
                  6] >= 97 && str[index + 6] <= 122) || (str[index + 6] >=
47 && str[index +
                  6] <= 57) || (str[index + 6] == 43)) && ((str[index + 7] >= 65 &&
                str[index +
...
(str[index +
                  11] >= 97 && str[index + 11] <= 122) || (str[index + 11] >= 47 &&
                str[index +
                  11] <= 57) || (str[index + 11] == 43)) && ((str[index +
12] >= 65 &&
                str[index + 12] <= 90) || (str[index + 12] >= 97 &&
str[index + 12] <= 122)
              ||
              (str[index + 12] >= 47 && str[index + 12] <= 57) || (str[index+
12] ==
                43)) && ((str[index + 13] >= 65 && str[index + 13] <= 90) ||
(str[index +
                  13] >= 97 && str[index + 13] <= 122) || (str[index + 13] >= 47 &&
                str[index +
                  13] <= 57) || (str[index + 13] == 43)) && ((str[index +
14] >= 65 &&
                str[index + 14] <= 90) || (str[index + 14] >= 97 &&
str[index + 14] <= 122)
              ||
              (str[index + 14] >= 47 && str[index + 14] <= 57) || (str[index+
14] ==
                43)) && ((str[index + 15] >= 65 && str[index + 15] <= 90) ||
(str[index +
                  15] >= 97 && str[index + 15] <= 122) || (str[index + 15] >= 47 &&
                str[index +
                  15] <= 57) || (str[index + 15] == 43)) && ((str[index +
16] >= 65 &&
                str[index + 16] <= 90) || (str[index + 16] >= 97 &&
str[index + 16] <= 122)
              ||
              (str[index + 16] >= 47 && str[index + 16] <= 57) || (str[index+
16] ==
                43)) && ((str[index + 17] >= 65 && str[index + 17] <= 90) ||
(str[index +
                  17] >= 97 && str[index + 17] <= 122) || (str[index + 17] >= 47 &&
                str[index +
                  17] <= 57) || (str[index + 17] == 43)) && ((str[index +
18] >= 65 &&
                str[index + 18] <= 90) || (str[index + 18] >= 97 &&
str[index + 18] <= 122)
              ||
              (str[index + 18] >= 47 && str[index + 18] <= 57) || (str[index+
18] ==
                43)) && ((str[index + 19] >= 65 && str[index + 19] <= 90) ||
(str[index +
                  19] >= 97 && str[index + 19] <= 122) || (str[index + 19] >= 47 &&
                str[index +
                  19] <= 57) || (str[index + 19] == 43)) && ((str[index +
20] >= 65 &&
                str[index + 20] <= 90) || (str[index + 20] >= 97 &&
str[index + 20] <= 122)
              ||
              (str[index + 20] >= 47 && str[index + 20] <= 57) || (str[index+
20] ==
                43)) && ((str[index + 21] >= 65 && str[index + 21] <= 90) ||
(str[index +
                  21] >= 97 && str[index + 21] <= 122) || (str[index + 21] >= 47 &&
                str[index + 21] <= 57) || (str[index + 21] == 43)))) {
          index += 22;
        } else {
          index = indexStart;
          break;
...
str[index] <=
        ...
        if (endIndex - index > 8 && (str[index] == 61) && (((str[index + 1] & ~32)
              ...
              (str[index + 4] & ~32) == 85 && (str[index + 5] & ~32) == 73 &&
(str[index +
        ...
        do {
          ...
          do {
            ...
            do {
              ...
              while (index < endIndex && ((str[index] >= 33 && str[index] <=
61) ||
                  (str[index] >= 63 && str[index] <= 90) || (str[index] >=
94 && str[index] <=
                    126))) {
                ++index;
              }
...
(str[index +
                1] & ~32) == 65 && (str[index + 2] & ~32) == 73 &&
(str[index + 3] & ~32) ==
            76) {
            indexTemp2 += 4;
          } else if (endIndex - index > 7 && (str[index] & ~32) == 83 &&
(str[index +
                1] & ~32) == 79 && (str[index + 2] & ~32) == 70 &&
(str[index + 3] & ~32) ==
            84 &&
...
(str[index +
                1] & ~32) == 79 && (str[index + 2] & ~32) == 78 &&
(str[index + 3] & ~32) ==
            69) {
            indexTemp2 += 4;
          } else if (endIndex - index > 8 && (str[index] & ~32) == 84 &&
(str[index +
                1] & ~32) == 69 && (str[index + 2] & ~32) == 77 &&
(str[index + 3] & ~32) ==
            80 &&
            (str[index + 4] & ~32) == 69 && (str[index + 5] & ~32) == 82 &&
...
str[index] <=
              ...
              while (index < endIndex && ((str[index] >= 33 && str[index] <=
39) ||
                  (str[index] >= 41 && str[index] <= 58) || (str[index] >=
60 && str[index] <=
                    126))) {
                ++index;
              }
...
9))) {
              ...
              if (index < endIndex && ((str[index] == 33) || (str[index] >=
35 &&
                    str[index] <= 91) || (str[index] >= 93 && str[index] <=
126))) {
                ++indexTemp3;
                break;
              }
    ...
    public static int ParsePhraseAtom (string str, int index, int endIndex,
      ...
      for (i = 0; true; ++i) {
        ...
        if (index < endIndex && ((str[index] >= 65 && str[index] <= 90) ||
            (str[index] == 33) || (str[index] >= 35 && str[index] <= 39) ||
(str[index]
              >= 42 && str[index] <= 43) || (str[index] == 45) ||
(str[index] >= 47 &&
              str[index] <= 57) || (str[index] == 61) || (str[index] == 63) ||
(str[index]
              >= 94 && str[index] <= 126) || (str[index] >= 128 &&
str[index] <= 55295) ||
            (str[index] >= 57344 && str[index] <= 65535))) {
          ++indexTemp2;
        } else if (endIndex - index > 1 && ((str[index] >= 55296 &&
...
36) ||
            (str[index] >= 38 && str[index] <= 44) || (str[index] >= 58 &&
str[index] <=
              59) || (str[index] == 61))) {
          ++indexTemp2;
        } else if (endIndex - index > 2 && (((str[index] == 37) &&
...
>= 42 &&
                        str[indexTemp3] <= 43) || (str[indexTemp3] >= 38 &&
str[indexTemp3] <= 39) ||
                (str[indexTemp3] == 63))) {
                    ++indexTemp3;
                  }
