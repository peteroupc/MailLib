...
namespace PeterO.Text {
    ...
    /// handled by this class include file and directory names, domain
    /// names, profile data voluntarily entered by users, and the text of
    /// article, post, and message bodies. The preparation and comparison
    /// of such strings is currently outside the scope of this
    /// class.</item>
