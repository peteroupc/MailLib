...
namespace PeterO.Text {
    ...
    /// comparison are outside the scope of this class.<br/>-- File and directory
    /// names.<br/>-- Domain
    /// names.<br/>-- Text strings with multiple language versions (such as a
    /// checkbox's label or a dialog box's title).<br/>-- Profile data voluntarily
    /// entered by users.<br/>-- The text of
    /// article, post, and message bodies.</item>
