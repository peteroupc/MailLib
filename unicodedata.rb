...
f.puts("/* Generated by unicodedata.rb from data from the Unicode Character Database.")
...
f.puts("      "+linebrokenjoinbytes(LZ4.compress(toByteArray(idnaScripts))))
f.puts("    };")
...
f.puts("      "+linebrokenjoinbytes(LZ4.compress(toByteArray(joining))))
f.puts("    };")
