...
namespace MailLibTest {
  ...
  public class CharsetsTest {
    ...
    public void TestShiftJIS() {
      ...
      Assert.AreEqual(expected, CharsetGetString(charset, EncodingTest.Transform(bytes)));
    }
    ...
    public void TestIso2022JP() {
      ...
      Assert.AreEqual(" Aa\\", CharsetGetString(charset, EncodingTest.Transform(bytes)));
      // Illegal byte in escape middle state
      bytes = new byte[] { 0x1b, 0x28, 0x47, 0x21, 0x41, 0x31, 0x5c };
      Assert.AreEqual("\ufffd\u0028\u0047!A1\\", CharsetGetString(charset, EncodingTest.Transform(bytes)));
      // Katakana
      bytes = new byte[] { 0x1b, 0x28, 0x49, 0x21, 0x41, 0x31, 0x5c };
      Assert.AreEqual("\uff61\uff81\uff71\uff9c", CharsetGetString(charset, EncodingTest.Transform(bytes)));
      bytes = new byte[] { 0x1b, 0x28, 0x49, 0x20, 0x41, 0x61, 0x5c };
      Assert.AreEqual("\ufffd\uff81\ufffd\uff9c", CharsetGetString(charset, EncodingTest.Transform(bytes)));
      ...
      Assert.AreEqual("\u3000\u3001\u3002", CharsetGetString(charset, EncodingTest.Transform(bytes)));
      ...
      Assert.AreEqual("\ufffd\u0024\u004f!!!\u0023!#", CharsetGetString(charset, EncodingTest.Transform(bytes)));
      // JIS0212 state
      ...
      Assert.AreEqual("\u02d8\u02c7\u00231", CharsetGetString(charset, EncodingTest.Transform(bytes)));
      ...
      Assert.AreEqual("A\ufffd", CharsetGetString(charset, EncodingTest.Transform(bytes)));
