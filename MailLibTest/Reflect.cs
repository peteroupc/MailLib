...
namespace MailLibTest {
  ...
  public static class Reflect {
    ...
    public static object Construct(string type, params object[] parameters) {
      try {
        return Activator.CreateInstance(FindType(type),
          BindingFlags.Instance | BindingFlags.Public |
 BindingFlags.NonPublic | BindingFlags.CreateInstance, null, parameters,
          null);
    ...
    public static object GetMethod(object obj, string name) {
      return obj.GetType().GetMethod(name, BindingFlags.Instance |
    ...
    public static object InvokeMethod(object obj, object method, params
      object[] parameters) {
      try {
    ...
    public static object Invoke(object obj, string name, params object[]
      parameters) {
      return InvokeMethod(obj, GetMethodExtended(obj.GetType(), name, false,
        parameters.Length), parameters);
    }
    public static object InvokeStatic(string type, string name, params
      object[] parameters) {
      return InvokeMethod(null, GetMethodExtended(FindType(type), name,
        true, parameters.Length), parameters);
    }
    public static object GetProperty(object obj, string name) {
      return InvokeMethod(obj, obj.GetType().GetProperty(name,
        BindingFlags.Public | BindingFlags.NonPublic |
