...
namespace MailLibTest {
  ...
  public static class Reflect {
    ...
    public static object Construct(string type, params object[] parameters) {
      try {
        return Activator.CreateInstance(FindType(type), BindingFlags.Instance | BindingFlags.Public |
        BindingFlags.NonPublic | BindingFlags.CreateInstance, null, parameters, null);
    ...
    public static object Invoke(object obj, string name, params object[] parameters) {
      return InvokeMethod(obj, GetMethodExtended(obj.GetType(), name, false, parameters.Length), parameters);
    }
    public static object InvokeStatic(string type, string name, params object[] parameters) {
      return InvokeMethod(null, GetMethodExtended(FindType(type), name, true, parameters.Length), parameters);
    }
    public static object GetProperty(object obj, string name) {
      return InvokeMethod(obj, obj.GetType().GetProperty(name, BindingFlags.Public | BindingFlags.NonPublic |
        BindingFlags.Instance | BindingFlags.GetProperty).GetGetMethod());
    }
    public static object GetPropertyStatic(string type, string name) {
      return InvokeMethod(null, FindType(type).GetProperty(name, BindingFlags.Public | BindingFlags.NonPublic |
        BindingFlags.Static | BindingFlags.GetProperty).GetGetMethod());
    }
    public static object GetField(object obj, string name) {
      return obj.GetType().GetField(name, BindingFlags.Public | BindingFlags.NonPublic |
        BindingFlags.Instance | BindingFlags.GetField).GetValue(obj);
    }
    public static object GetFieldStatic(string type, string name) {
      return FindType(type).GetField(name, BindingFlags.Public | BindingFlags.NonPublic |
        BindingFlags.Static | BindingFlags.GetField).GetValue(null);
    }
  }
}
