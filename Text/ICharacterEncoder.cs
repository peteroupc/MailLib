...
namespace PeterO.Text {
    /// <summary>Defines a method that can be implemented by classes that convert
    /// Unicode code points to bytes.</summary>
  public interface ICharacterEncoder {
    ...
    /// written. The decoder can maintain internal state, including data on bytes
    /// already passed as input, so this parameter should not change when using the
    /// same character encoder object.</param>
