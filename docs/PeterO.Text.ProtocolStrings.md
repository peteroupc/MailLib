 ...
 * The methods in this class are not well suited for<i>collation</i>, or lexicographic ordering, which is a comparison of text strings hat is usually language-dependent and goes beyond equality omparison. Further discussion on collation can be found in Unicode echnical Standard 10 (UTS 10), "Unicode Collation Algorithm".
