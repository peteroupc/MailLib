...
* <code>[GetCreationDate()](#GetCreationDate)</code> - Not documented yet.
* <code>[GetFilename()](#GetFilename)</code> - Not documented yet.
* <code>[GetHashCode()](#GetHashCode)</code> -
* <code>[GetModificationDate()](#GetModificationDate)</code> - Not documented yet.
* <code>[GetParameter(string)](#GetParameter_string)</code> - Gets a parameter from this disposition object.
* <code>[GetReadDate()](#GetReadDate)</code> - Not documented yet.
* <code>[public static readonly PeterO.Mail.ContentDisposition Inline;](#Inline)</code> - The content disposition value "inline" .
* <code>[IsAttachment](#IsAttachment)</code> - Gets a value not documented yet.
...
* <code>[Parameters](#Parameters)</code> - Gets a value not documented yet.
