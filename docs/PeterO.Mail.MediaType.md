## PeterO.Mail.MediaType
 ...
 <b>Note:</b> According to RFC 2049, unrecognized subtypes of the top-level type  `multipart` multipart must be treated as  `multipart/mixed` multipart/mixed and unrecognized media types as the media type  `application/octet-stream` application/octet-stream .
...
### Parameters
 ...
 Gets a list of the parameters contained in this media type object.  <b>Returns:</b>
...
### SubType
 ...
 Gets this media type's subtype (for example, "plain" in "text/plain"). The resulting string will be in lowercase letters.  <b>Returns:</b>
...
### TopLevelType
 ...
 Gets the name of this media type's top-level type (such as "text" in "text/plain", or "audio" in "audio/basic"). The resulting string will be in lowercase letters.  <b>Returns:</b>
...
### TypeAndSubType
 ...
 Gets the top level type and subtype of this media type, separated by a slash; for example, "text/plain". The resulting string will be in lowercase letters.  <b>Returns:</b>
