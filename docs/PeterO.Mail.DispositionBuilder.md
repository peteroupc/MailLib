...
<b>Obsolete.</b> Use ContentDisposition.Builder instead.
...
Initializes a new instance of the [PeterO.Mail.DispositionBuilder](PeterO.Mail.DispositionBuilder.md) class using the specified disposition type.
