...
import com.upokecenter.text.*;
  ...
  public class Address {
     ...
     * class.
     * @param addressValue An email address. This parameter must contain an
     * at-sign, and may not contain extraneous whitespace, and comments enclosed in
     * parentheses are also not allowed.
     ...
     * '@'sign; Invalid local part; Expected '@'sign after local part; Expected
     * domain after '@'; Invalid domain; Address too long.
     */
