 ...
 return charsetAliases.containsKey(name) ? charsetAliases.get(name) :
    ...
    public static ICharset GetCharset(String name) {
      ...
      if (name.equals("windows-1252")) {
        return new SingleByteEncoding(new int[] { 8364,
          129, 8218,
          402, 8222,
          8230, 8224,
          8225, 710,
      ...
      if (name.equals("iso-8859-3")) {
        ...
        return new SingleByteEncoding(new int[] { 9472, 9474, 9484, 9488, 9492,
        ...
        return new SingleByteEncoding(new int[] { 8364, 129, 8218, 131, 8222,
        ...
        return new SingleByteEncoding(new int[] { 1026, 1027, 8218, 1107, 8222,
        ...
        return new SingleByteEncoding(new int[] { 8364, 129, 8218, 402, 8222,
        ...
        return new SingleByteEncoding(new int[] { 8364, 1662, 8218, 402, 8222,
        ...
        return new SingleByteEncoding(new int[] { 8364, 129, 130, 131, 132,
        ...
        return new SingleByteEncoding(new int[] { 1040, 1041, 1042, 1043, 1044,
