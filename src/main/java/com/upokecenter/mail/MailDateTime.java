...
private MailDateTime() {
     ...
     * {@code ParseDateString(string, boolean)} for information on the format of
     * this parameter.
     ...
     * {@code str} is null, empty, or syntactically invalid, or if the string's
     ...
     * ParseDateString(string, boolean)} for information on this method's return
     * value.
     * @param str A date-time string.
     * @return An 8-element array containing the date and time, or {@code null} if
     * {@code str} is null, empty, or syntactically invalid, or if the string's
