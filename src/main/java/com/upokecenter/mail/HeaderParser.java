...
ITokener tokener) {
      ...
      do {
        ...
        if (index + 2 < endIndex && (((str.charAt(index) & ~32) == 74 && (str.charAt(index +
          1) & ~32) == 65 && (str.charAt(index + 2) & ~32) == 78) || ((str.charAt(index) & ~32) == 70 && (str.charAt(index + 1) & ~32) == 69 && (str.charAt(index + 2) & ~32)
            == 66) || ((str.charAt(index) & ~32) == 77 && (str.charAt(index + 1) & ~32)
...
ITokener tokener) {
      ...
      do {
        ...
        if (index + 2 < endIndex && (((str.charAt(index) & ~32) == 77 && (str.charAt(index +
          1) & ~32) == 79 && (str.charAt(index + 2) & ~32) == 78) || ((str.charAt(index) & ~32) == 84 && (str.charAt(index + 1) & ~32) == 85 && (str.charAt(index + 2) & ~32)
            == 69) || ((str.charAt(index) & ~32) == 87 && (str.charAt(index + 1) & ~32)
      ...
      do {
        ...
        if (index < endIndex && ((str.charAt(index) >= 65 && str.charAt(index) <= 90) ||
          ...
          while (indexTemp < endIndex && ((str.charAt(indexTemp) >= 65 &&
            str.charAt(indexTemp) <= 90) || (str.charAt(indexTemp) >= 97 && str.charAt(indexTemp)
            <= 122) || (str.charAt(indexTemp) >= 48 && str.charAt(indexTemp) <= 57) ||
            (str.charAt(indexTemp) == 45) || (str.charAt(indexTemp) == 95))) {
            ++indexTemp;
          }
          break;
        }
...
ITokener tokener) {
      ...
      == 81 && (str.charAt(index + 4) & ~32) == 85 && (str.charAt(index + 5) & ~32) == 73 &&
          ...
          (str.charAt(index + 4) & ~32) == 73 && (str.charAt(index + 5) & ~32) == 79 &&
          (str.charAt(index + 6) & ~32) == 78 && (str.charAt(index + 7) & ~32) == 65 &&
          (str.charAt(index + 8) & ~32) == 76))) {
          index += 9;
        } else {
          index = indexStart;
          break;
        ...
        for (int i = 0;; ++i) {
          ...
          do {
            ...
            if (index + 1 < endIndex && (str.charAt(index) == 46) && ((str.charAt(index +
              ...
              str.charAt(index + 1) <= 122) || (str.charAt(index + 1) >= 48 && str.charAt(index +
              1) <= 57))) {
              index += 2;
            } else {
              break;
      ...
      do {
        ...
        if (index < endIndex && ((str.charAt(index) == 33) || (str.charAt(index) >= 35 &&
          ...
          while (index < endIndex && ((str.charAt(index) == 33) || (str.charAt(index) >=
            ...
            126) || (str.charAt(index) >= 42 && str.charAt(index) <= 43) || (str.charAt(index) >=
...
ITokener tokener) {
      ...
      do {
       ...
       == 73 && (str.charAt(index + 7) & ~32) == 79 && (str.charAt(index + 8) & ~32) ==
                78) {
              indexTemp2 += 9; break;
            }
...
ITokener tokener) {
      ...
      do {
       ...
       == 82 && (str.charAt(index + 7) & ~32) == 79 && (str.charAt(index + 8) & ~32) ==
                82) {
              indexTemp2 += 9; break;
            }
        ...
        for (int i = 0;; ++i) {
          ...
          do {
            ...
            if (index < endIndex && ((str.charAt(index) == 33) || (str.charAt(index) >= 35 &&
              str.charAt(index) <= 36) || (str.charAt(index) >= 45 && str.charAt(index) <= 46) ||
              (str.charAt(index) >= 48 && str.charAt(index) <= 57) || (str.charAt(index) >= 65 &&
              str.charAt(index) <= 90) || (str.charAt(index) >= 94 && str.charAt(index) <=
              126) || (str.charAt(index) >= 42 && str.charAt(index) <= 43) || (str.charAt(index)
              >= 38 && str.charAt(index) <= 39) || (str.charAt(index) == 63))) {
              ++index;
              while (index < endIndex && ((str.charAt(index) == 33) || (str.charAt(index)
                >= 35 && str.charAt(index) <= 36) || (str.charAt(index) >= 45 &&
                str.charAt(index) <= 46) || (str.charAt(index) >= 48 && str.charAt(index) <= 57) ||
                (str.charAt(index) >= 65 && str.charAt(index) <= 90) || (str.charAt(index) >=
                94 && str.charAt(index) <= 126) || (str.charAt(index) >= 42 && str.charAt(index)
...
ITokener tokener) {
      ...
      do {
        ...
        do {
          ...
          while (index + 1 < endIndex && ((str.charAt(index) == 45) && ((str.charAt(index +
            1) >= 65 && str.charAt(index + 1) <= 90) || (str.charAt(index + 1) >= 97 &&
            str.charAt(index + 1) <= 122) || (str.charAt(index + 1) >= 48 && str.charAt(index +
            1) <= 57)))) {
            index += 2;
        ...
        do {
          ...
          while (true) {
           ...
           if (index < endIndex && ((str.charAt(index) == 32) || (str.charAt(index) ==
              ...
              if (index + 1 < endIndex && ((str.charAt(index) == 92) && ((str.charAt(index +
                1) >= 32 && str.charAt(index + 1) <= 126) || (str.charAt(index + 1) ==
                9)))) {
                indexTemp3 += 2; break;
              }
            } while (false);
      ...
      do {
        ...
        while (true) {
          ...
          do {
            ...
            if (index < endIndex && ((str.charAt(index) >= 65 && str.charAt(index) <= 90) ||
              (str.charAt(index) >= 97 && str.charAt(index) <= 122) || (str.charAt(index) >=
              48 && str.charAt(index) <= 57) || (str.charAt(index) == 43) || (str.charAt(index)
              == 45) || (str.charAt(index) == 95))) {
              ++index;
              while (index < endIndex && ((str.charAt(index) >= 65 && str.charAt(index) <=
                90) || (str.charAt(index) >= 97 && str.charAt(index) <= 122) ||
      ...
      do {
        while (true) {
          ...
          do {
            if (index < endIndex && ((str.charAt(index) >= 65 && str.charAt(index) <= 90) ||
              (str.charAt(index) >= 97 && str.charAt(index) <= 122) || (str.charAt(index) >=
              48 && str.charAt(index) <= 57) || (str.charAt(index) >= 45 && str.charAt(index) <=
              46) || (str.charAt(index) == 95) || (str.charAt(index) == 126))) {
              ++indexTemp2; break;
            }
              ...
              do {
                ...
                do {
                  ...
                  if (index < endIndex && ((str.charAt(index) == 33) || (str.charAt(index)
                    ...
                    (str.charAt(index) == 43) || (str.charAt(index) >= 45 && str.charAt(index) <=
...
ITokener tokener) {
      ...
      do {
       ...
       == 65 && (str.charAt(index + 7) & ~32) == 84 && (str.charAt(index + 8) & ~32) ==
                69) {
              indexTemp2 += 9; break;
            }
...
ITokener tokener) {
      ...
      do {
        if (index + 7 < endIndex && (str.charAt(index) & ~32) == 77 && (str.charAt(index +
          1) & ~32) == 65 && (str.charAt(index + 2) & ~32) == 73 && (str.charAt(index + 3) & ~32) == 76 && (str.charAt(index + 4) & ~32) == 70 && (str.charAt(index + 5) & ~32)
            == 82 && (str.charAt(index + 6) & ~32) == 79 && (str.charAt(index + 7) & ~32) ==
            77) {
          indexTemp += 8; break;
        }
        if (index + 5 < endIndex && (str.charAt(index) & ~32) == 82 && (str.charAt(index +
          1) & ~32) == 67 && (str.charAt(index + 2) & ~32) == 80 && (str.charAt(index + 3) & ~32) == 84 && (str.charAt(index + 4) & ~32) == 84 && (str.charAt(index + 5) & ~32)
            == 79) {
          indexTemp += 6; break;
        }
        // Unlimited production in choice
...
ITokener tokener) {
      ...
      do {
        ...
        if (index + 5 < endIndex && (str.charAt(index) & ~32) == 72 && (str.charAt(index +
          1) & ~32) == 69 && (str.charAt(index + 2) & ~32) == 65 && (str.charAt(index + 3) & ~32) == 68 && (str.charAt(index + 4) & ~32) == 69 && (str.charAt(index + 5) & ~32)
            == 82) {
          indexTemp += 6; break;
        }
        ...
        if (index + 5 < endIndex && (str.charAt(index) & ~32) == 80 && (str.charAt(index +
          1) & ~32) == 79 && (str.charAt(index + 2) & ~32) == 76 && (str.charAt(index + 3) & ~32) == 73 && (str.charAt(index + 4) & ~32) == 67 && (str.charAt(index + 5) & ~32)
            == 89) {
          indexTemp += 6; break;
        }
      } while (false);
...
ITokener tokener) {
      ...
      do {
        if (index + 5 < endIndex && (str.charAt(index) & ~32) == 82 && (str.charAt(index +
          1) & ~32) == 69 && (str.charAt(index + 2) & ~32) == 65 && (str.charAt(index + 3) & ~32) == 83 && (str.charAt(index + 4) & ~32) == 79 && (str.charAt(index + 5) & ~32)
            == 78) {
          index += 6;
        } else {
          break;
      ...
      do {
        while (true) {
          ...
          do {
            ...
            if (index < endIndex && ((str.charAt(index) == 33) || (str.charAt(index) ==
              36) || (str.charAt(index) >= 38 && str.charAt(index) <= 44) || (str.charAt(index)
              >= 58 && str.charAt(index) <= 59) || (str.charAt(index) == 61))) {
              ++indexTemp2; break;
            }
            if (index + 2 < endIndex && ((str.charAt(index) == 37) && (((str.charAt(index +
              1) >= 48 && str.charAt(index + 1) <= 57) || (str.charAt(index + 1) >= 65 &&
...
ITokener tokener) {
      ...
      do {
        ...
        if (index + 7 < endIndex && (str.charAt(index) & ~32) == 83 && (str.charAt(index +
          1) & ~32) == 79 && (str.charAt(index + 2) & ~32) == 70 && (str.charAt(index + 3) & ~32) == 84 && (str.charAt(index + 4) & ~32) == 70 && (str.charAt(index + 5) & ~32)
            == 65 && (str.charAt(index + 6) & ~32) == 73 && (str.charAt(index + 7) & ~32) ==
            76) {
          indexTemp += 8; break;
        }
        if (index + 6 < endIndex && (str.charAt(index) & ~32) == 78 && (str.charAt(index +
          1) & ~32) == 69 && (str.charAt(index + 2) & ~32) == 85 && (str.charAt(index + 3) & ~32) == 84 && (str.charAt(index + 4) & ~32) == 82 && (str.charAt(index + 5) & ~32)
            == 65 && (str.charAt(index + 6) & ~32) == 76) {
          indexTemp += 7; break;
        }
        if (index + 3 < endIndex && (str.charAt(index) & ~32) == 78 && (str.charAt(index +
          1) & ~32) == 79 && (str.charAt(index + 2) & ~32) == 78 && (str.charAt(index + 3) & ~32) == 69) {
        ...
        if (index + 8 < endIndex && (str.charAt(index) & ~32) == 84 && (str.charAt(index +
          1) & ~32) == 69 && (str.charAt(index + 2) & ~32) == 77 && (str.charAt(index + 3) & ~32) == 80 && (str.charAt(index + 4) & ~32) == 69 && (str.charAt(index + 5) & ~32)
            == 82 && (str.charAt(index + 6) & ~32) == 82 && (str.charAt(index + 7) & ~32) ==
            79 && (str.charAt(index + 8) & ~32) == 82) {
          indexTemp += 9; break;
        }
        if (index + 8 < endIndex && (str.charAt(index) & ~32) == 80 && (str.charAt(index +
          1) & ~32) == 69 && (str.charAt(index + 2) & ~32) == 82 && (str.charAt(index + 3) & ~32) == 77 && (str.charAt(index + 4) & ~32) == 69 && (str.charAt(index + 5) & ~32)
            == 82 && (str.charAt(index + 6) & ~32) == 82 && (str.charAt(index + 7) & ~32) ==
            79 && (str.charAt(index + 8) & ~32) == 82) {
          indexTemp += 9; break;
        }
...
ITokener tokener) {
      ...
      do {
        ...
        if (index + 10 < endIndex && (str.charAt(index) & ~32) == 84 && (str.charAt(index +
          ...
          3) & ~32) == 78 && (str.charAt(index + 4) & ~32) == 83 && (str.charAt(index + 5) & ~32) == 65 && (str.charAt(index + 6) & ~32) == 67 && (str.charAt(index + 7) & ~32)
            == 84 && (str.charAt(index + 8) & ~32) == 73 && (str.charAt(index + 9) & ~32) ==
            79 && (str.charAt(index + 10) & ~32) == 78) {
          indexTemp += 11; break;
        }
      } while (false);
      return indexTemp;
