...
import com.upokecenter.text.*;
  ...
  public class DomainTest
  {
    ...
    public void IdnaTest() {
      ...
      if(Idna.IsValidDomainName("1domain.example.\u05d0\u05d0",false))Assert.fail();
      if(Idna.IsValidDomainName("\u05d0\u05d0.1domain.example",false))Assert.fail();
      ...
      if(Idna.IsValidDomainName("\ua840\u0300\u0300\u200d\u0300\u0300\ua840",false))Assert.fail();
      ...
      if(!(Idna.IsValidDomainName("\ua840\u0300\u0300\u200c\ua840",false)))Assert.fail();
      if(!(Idna.IsValidDomainName("\ua840\u0300\u0300\u200c\u0300\u0300\ua840",false)))Assert.fail();
      ...
      if(Idna.IsValidDomainName("\u0627\u05f3",false))Assert.fail();  // Arabic (non-Hebrew)
      if(!(Idna.IsValidDomainName("\u05d0\u05f4",false)))Assert.fail();  // Hebrew
      if(Idna.IsValidDomainName("\u0627\u05f4",false))Assert.fail();  // Arabic (non-Hebrew)
      ...
      if(!(Idna.IsValidDomainName("\u062d\u0300\u0300\u200c\u0300\u0300\u062f",false)))Assert.fail();
      // Right-joining character on left side
      if(Idna.IsValidDomainName("\u062f\u200c\u062d",false))Assert.fail();
      if(Idna.IsValidDomainName("\u062f\u0300\u0300\u200c\u0300\u0300\u062d",false))Assert.fail();
    }
  }
