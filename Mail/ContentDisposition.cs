...
namespace PeterO.Mail {
  ...
  public class ContentDisposition {
    ...
    internal ContentDisposition(string type, IDictionary<string, string>
      parameters) {
    ...
    public static string MakeFilename(string str) {
      ...
      if (str.IndexOf("=?", StringComparison.Ordinal) >= 0) {
        ...
        string charset = Charsets.ResolveAliasForEmail(str.Substring(0,
          str.IndexOf('\'')));
    ...
    c == ':' || c == '<' || c == '>' || c == '"' || (c >= 0x7f && c <=
      ...
      if (strLower.Equals("nul") || strLower.IndexOf("nul.",
        StringComparison.Ordinal) == 0 ||
          strLower.Equals("prn") || strLower.IndexOf("prn.",
            StringComparison.Ordinal) == 0 ||
          strLower.Equals("aux") || strLower.IndexOf("aux.",
            StringComparison.Ordinal) == 0 ||
          strLower.Equals("con") || strLower.IndexOf("con.",
            StringComparison.Ordinal) == 0 ||
          (strLower.Length >= 4 && strLower.IndexOf("lpt",
            StringComparison.Ordinal) == 0 && strLower[3] >= '1' &&
       strLower[3] <= '9') || (strLower.Length >= 4 &&
              strLower.IndexOf("com",
            StringComparison.Ordinal) == 0 && strLower[3] >= '1' &&
            strLower[3] <= '9')) {
